function main() {
  ...
  Operate.newStart(
    "Please enter coefficients a1, a2, a3, a4, a5, b1, b2, b3, b4, b5, c1, c2, c3, c4, c5, d1, d2, d3. d4, d5, e1, e2, e3, e4, e5, f1, f2, f3, f4, f5:"
  );
  ...
  Operate.newInput([
    ...
    Operate.newStep(
      `Entered\\ coefficients: a1 = ${a1}, a2 = ${a2}, a3 = ${a3}, a4 = ${a4}, a5 = ${a5}, b1 = ${b1}, b2 = ${b2}, b3 = ${b3}, b4 = ${b4}, b5 = ${b5}, c1 = ${c1}, c2 = ${c2}, c3 = ${c3}, c4 = ${c4}, c5 = ${c5}, d1 = ${d1}, d2=${d2}, d3 = ${d4}, d3 = ${d4}, d5 = ${d5}, e1 = ${e1}, e2=${e2}, e3 = ${e3}, e4 = ${e4}, e5 = ${e5}, f1 = ${f1}, f2=${f2}, f3 = ${f3}, f4 = ${f4}, f5 = ${f5}`
    );
    let solution = [];
  ...
  function solveEquation(coefficientsArray) {
        ...
        for (var j = 1; j < counter; j++) {
          if (j == i + 1) {
            ...
            for (var k = 0; k <= counter; k++) {
              var difference =
                differenceArray[i][k] - differenceArray[j][k] * multiplier;
    ...
    var firstVariable =
      tempEquationArray[tempEquationArray.length - 1][1] /
      tempEquationArray[tempEquationArray.length - 1][0];
    ...
    for (var i = tempEquationArray.length - 1; i >= 0; i--) {
      ...
      for (var j = tempEquationArray[i].length - 1; j >= 1; j--) {
        if (j == tempEquationArray[i].length - 1) {
          ...
          tempArray.push(
            tempArray[index] - solutions[index] * tempEquationArray[i][j]
          );
          index++;
        }
      }
      if (
        tempArray[index] / tempEquationArray[i][0] != 0 &&
        tempArray[index] / tempEquationArray[i][0] != solutions[0]
      ) {
