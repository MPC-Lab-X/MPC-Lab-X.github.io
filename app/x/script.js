        ...
        if (user_selectArray[i]._checked == true) {
          for (let j = 0; j < user_selectArray[i].topics.length; j++) {
            if (user_selectArray[i].topics[j]._checked == true) {
              for (
                let x = 0;
                x < user_selectArray[i].topics[j].subtopics.length;
                x++
              ) {
            ...
            for (
              ...
              if (user_selectArray[i].topics[j].subtopics[x]._checked == "/") {
                if (back[f] == true) {
                  ...
                  replaceSlashWithFalse(
                    user_selectArray[i].topics[j].subtopics[x]
                  );
                }
                f++;
              }
                ...
                for (
                  ...
                  if (
                    ...
                    for (
                      let n = 0;
                      n <
                      user_selectArray[i].topics[j].subtopics[x].subtopics
                        .length;
                      n++
                    ) {
                      get_.push(
                        user_selectArray[i].topics[j].subtopics[x].subtopics[n]
                          .name
                      );
                    }
                  }
            ...
            for (let j = 0; j < user_selectArray[i].topics.length; j++) {
              for (
                ...
                for (
                  let q = 0;
                  q <
                  user_selectArray[i].topics[j].subtopics[x].subtopics.length;
                  q++
                ) {
                  if (
                    user_selectArray[i].topics[j].subtopics[x].subtopics[q]
                      ._checked == "/"
                  ) {
                    if (back[f] == true) {
                      user_selectArray[i].topics[j].subtopics[x].subtopics[
