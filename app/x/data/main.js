function loadScripts(scriptUrls, callback) {
  ...
  function loadScript(url, index) {
    return new Promise((resolve, reject) => {
      ...
      script.onload = function () {
        ...
        APP.log(
          `Script loading progress: ${loadedScripts}/${totalScripts} - ${progress.toFixed(
            2
          )}%`,
          1000
        );
  ...
  (async function () {
    ...
    APP.log(
      `All scripts loaded, total loading time: ${loadTime.toFixed(2)} Second`,
      3000
    );
    setTimeout(() => {
...
let scriptsToLoad = [
  ...
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Corresponding_angles.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Alternate_angles.js",
  ...
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Area_of_Circle.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Circumference_of_Circle.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Inscribed_Square_in_Circle.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Arc_Length_of_Circle.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Distance_of_Chord_Intersection.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Area_of_Triangle.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Perimeter_of_Triangle.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Angle_Sum_Property.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Pythagorean_Theorem_in_Triangles.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Similar_Triangles_Property.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Interior_Angles.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Corresponding_Exterior_Angles.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Alternate_Interior_Angles.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Alternate_Exterior_Angles.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Trapezoid_Area.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Trapezoid_Perimeter.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Trapezoid_Height.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Geometry/Trigonometry.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Statistics_and_Probability/Data_collection_and_analysis.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Statistics_and_Probability/Basic_probability_concepts.js",
  MPCLabAPIurl +
    "/data/math/Middle_School_Mathematics/Statistics_and_Probability/Probability_calculations.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Trigonometry/Properties_and_graphs_of_trigonometric_functions.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Trigonometry/Trigonometric_identities.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Trigonometry/Solving_trigonometric_equations.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Sequences_and_Series/Arithmetic_and_geometric_sequences.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Sequences_and_Series/Summation_of_sequences.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Sequences_and_Series/Properties_of_series.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Calculus/Calculating_derivatives_and_their_applications.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Calculus/Indefinite_and_definite_integrals.js",
  MPCLabAPIurl +
    "/data/math/High_School_Mathematics/Calculus/Differential_equations.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Linear_Algebra/Matrices_and_determinants.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Linear_Algebra/Vector_spaces_and_linear_transformations.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Linear_Algebra/Eigenvalues_and_eigenvectors.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Differential_Equations/Higher_order_differential_equations.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Differential_Equations/Solution_methods_for_ordinary_differential_equations.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Probability_and_Statistics/Random_variables_and_probability_distributions.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Probability_and_Statistics/Statistical_inference_and_hypothesis_testing.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Complex_Analysis/Complex_numbers_and_complex_functions.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Complex_Analysis/Analytic_functions_and_conformal_mappings.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Linear_Programming/Modeling_and_solving_linear_programming_problems.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Discrete_Mathematics/Graph_theory.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Discrete_Mathematics/Combinatorics.js",
  MPCLabAPIurl +
    "/data/math/University_Mathematics/Discrete_Mathematics/Applications_of_discrete_mathematics_in_computer_science.js",
  MPCLabAPIurl +
    "/data/physics/Elementary_Physics/Basic_Physics_Concepts/Matter_and_its_Properties.js",
  MPCLabAPIurl +
    "/data/physics/Elementary_Physics/Basic_Physics_Concepts/Size_Shape_and_Color_of_Objects.js",
  MPCLabAPIurl +
    "/data/physics/Elementary_Physics/Basic_Physics_Concepts/Position_and_Direction_of_Objects.js",
  MPCLabAPIurl +
    "/data/physics/Elementary_Physics/Force_and_Motion/Concept_of_Force.js",
  MPCLabAPIurl +
    "/data/physics/Elementary_Physics/Force_and_Motion/Motion_and_Rest_of_Objects.js",
  MPCLabAPIurl +
    "/data/physics/Elementary_Physics/Force_and_Motion/Simple_Machines.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Thermodynamics/Temperature_and_Temperature_Measurement.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Thermodynamics/Heat_Conduction_and_Transfer.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Thermodynamics/Thermal_Expansion_of_Materials.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Electromagnetism/Electric_Charge_and_Static_Electricity.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Electromagnetism/Electric_Current_and_Circuits.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Electromagnetism/Magnetic_Fields_and_Electromagnetic_Induction.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Acoustics/Propagation_of_Sound.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Acoustics/Characteristics_and_Frequency_of_Sound.js",
  MPCLabAPIurl +
    "/data/physics/Middle_School_Physics/Acoustics/Sound_Reflection_and_Absorption.js",
  MPCLabAPIurl + "/data/physics/High_School_Physics/Mechanics/Kinematics.js",
  MPCLabAPIurl +
    "/data/physics/High_School_Physics/Mechanics/Newton_Laws_and_Equilibrium_of_Forces.js",
  MPCLabAPIurl +
    "/data/physics/High_School_Physics/Mechanics/Momentum_and_Energy.js",
  MPCLabAPIurl +
    "/data/physics/High_School_Physics/Optics/Propagation_and_Reflection_of_Light.js",
  MPCLabAPIurl +
    "/data/physics/High_School_Physics/Optics/Mirrors_and_Lenses.js",
  MPCLabAPIurl +
    "/data/physics/High_School_Physics/Optics/Wave_Particle_Duality_of_Light.js",
  MPCLabAPIurl +
    "/data/physics/High_School_Physics/Atomic_and_Nuclear_Physics/Atomic_Structure_and_the_Periodic_table.js",
  MPCLabAPIurl +
    "/data/physics/High_School_Physics/Atomic_and_Nuclear_Physics/Nuclear_Reactions_and_Radioactive_Decay.js",
  MPCLabAPIurl +
    "/data/physics/High_School_Physics/Atomic_and_Nuclear_Physics/Structure_of_Atomic_Nuclei.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Thermodynamics/Ideal_Gas_Law.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Thermodynamics/Thermodynamic_Cycles.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Thermodynamics/Entropy_and_the_Second_Law_of_Thermodynamics.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Electromagnetism/Maxwell_Equations.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Electromagnetism/Electromagnetic_Waves_and_the_Propagation_of_Light.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Electromagnetism/Interaction_of_Electromagnetic_Fields.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Quantum_Mechanics/Wave_Particle_Duality.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Quantum_Mechanics/Wave_Functions_and_the_Schrodinger_Equation.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Quantum_Mechanics/Operators_and_Measurements_in_Quantum_Mechanics.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Relativity/Special_Relativity_and_the_Lorentz_Transformation.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Relativity/Mass_Energy_Equivalence.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Relativity/Gravity_and_General_Relativity.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Solid_State_Physics/Crystal_Structures_and_Lattice_Vibrations.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Solid_State_Physics/Electronic_Band_Theory.js",
  MPCLabAPIurl +
    "/data/physics/University_Physics/Solid_State_Physics/Semiconductors_and_Conductors.js",
  MPCLabAPIurl +
    "/data/chemistry/Elementary_Chemistry/Matter_and_Properties/Classification_of_Matter.js",
  MPCLabAPIurl +
    "/data/chemistry/Elementary_Chemistry/Matter_and_Properties/Properties_of_Matter.js",
  MPCLabAPIurl +
    "/data/chemistry/Elementary_Chemistry/Mixtures_and_Pure_Substances/Differences_between_Mixtures_and_Pure_Substances.js",
  MPCLabAPIurl +
    "/data/chemistry/Elementary_Chemistry/Mixtures_and_Pure_Substances/Methods_to_Separate_Mixtures.js",
  MPCLabAPIurl +
    "/data/chemistry/Middle_School_Chemistry/Elements_and_Compounds/Definitions_of_Elements_and_Compounds.js",
  MPCLabAPIurl +
    "/data/chemistry/Middle_School_Chemistry/Elements_and_Compounds/Chemical_Symbols_and_the_Periodic_table.js",
  MPCLabAPIurl +
    "/data/chemistry/Middle_School_Chemistry/Chemical_Reactions/Basic_Concepts_of_Chemical_Reactions.js",
  MPCLabAPIurl +
    "/data/chemistry/Middle_School_Chemistry/Chemical_Reactions/Chemical_Reaction_Equations.js",
  MPCLabAPIurl +
    "/data/chemistry/Middle_School_Chemistry/Acids_and_Bases/Properties_of_Acids_and_Bases.js",
  MPCLabAPIurl +
    "/data/chemistry/Middle_School_Chemistry/Acids_and_Bases/Neutralization_Reactions.js",
  MPCLabAPIurl +
    "/data/chemistry/High_School_Chemistry/Chemical_Bonds_and_Molecular_Structure/Atomic_and_Molecular_Structure.js",
  MPCLabAPIurl +
    "/data/chemistry/High_School_Chemistry/Chemical_Bonds_and_Molecular_Structure/Covalent_and_Ionic_Bonds.js",
  MPCLabAPIurl +
    "/data/chemistry/High_School_Chemistry/Chemical_Reaction_Kinetics/Reaction_Rates_and_Activation_Energy.js",
  MPCLabAPIurl +
    "/data/chemistry/High_School_Chemistry/Chemical_Reaction_Kinetics/Chemical_Equilibrium_and_Le_Chatelier_Principle.js",
  MPCLabAPIurl +
    "/data/chemistry/High_School_Chemistry/Chemical_Reaction_Kinetics/Equilibrium_Constants_for_Chemical_Reactions.js",
  MPCLabAPIurl +
    "/data/chemistry/High_School_Chemistry/Chemical_Thermodynamics/Heat_and_Enthalpy.js",
  MPCLabAPIurl +
    "/data/chemistry/High_School_Chemistry/Chemical_Thermodynamics/Thermochemical_Equations.js",
  MPCLabAPIurl +
    "/data/chemistry/High_School_Chemistry/Chemical_Thermodynamics/Reaction_Enthalpy_and_Entropy_Changes.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Organic_Chemistry/Structure_and_Nomenclature_of_Organic_Molecules.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Organic_Chemistry/Reaction_Mechanisms_in_Organic_Chemistry.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Inorganic_Chemistry/Metal_and_non_Metal_Elements.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Inorganic_Chemistry/Coordination_Chemistry_and_Transition_Metal_Compounds.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Analytical_Chemistry/Methods_of_Chemical_Analysis.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Analytical_Chemistry/Mass_Spectrometry_and_Infrared_Spectroscopy.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Properties_of_Matter/Solubility_and_Solution_Concentration.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Properties_of_Matter/Redox_Reactions.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Nuclear_Chemistry/Radioactive_Decay_Processes.js",
  MPCLabAPIurl +
    "/data/chemistry/University_Chemistry/Nuclear_Chemistry/Nuclear_Reactions_and_Nuclear_Energy.js",
];
    ...
    if (Array.isArray(gl_results[i][0])) {
      for (let j = 0; j < gl_results[i][0].length; j++) {
        X_Operate.newStep(
          gl_results[i][0][j],
          false,
          containsKaTeXExpression(gl_results[i][0][j])
        );
      }
    } else {
      X_Operate.newStep(
        gl_results[i][0],
        false,
        containsKaTeXExpression(gl_results[i][0])
      );
    }
    if (Array.isArray(gl_results[i][1])) {
      if (gl_results[i][1].length === 2) {
        X_Operate.newStep(
          "\\frac{" + gl_results[i][1][0] + "}{" + gl_results[i][1][1] + "}",
          true,
          true
        );
      } else {
        X_Operate.newStep("Invalid Array", true, false);
      }
    } else {
      X_Operate.newStep(
        gl_results[i][1],
        true,
        containsKaTeXExpression(String(gl_results[i][1]))
      );
    }
  }
    ...
    if (Array.isArray(gl_results[i][0])) {
        ...
        if (containsKaTeXExpression(String(gl_results[i][0][j]))) {
          newWindow.document.write(
            `<p style='text-align: center;'>${String(
              i + 1
            )}. ${katex.renderToString(gl_results[i][0][j])}</p>`
          );
        } else {
          newWindow.document.write(
            `<p style='text-align: center;'>${String(i + 1)}. ${
              gl_results[i][0][j]
            }</p>`
          );
        }
      ...
      if (containsKaTeXExpression(String(gl_results[i][0]))) {
        newWindow.document.write(
          `<p style='text-align: center;'>${String(
            i + 1
          )}. ${katex.renderToString(gl_results[i][0])}</p>`
        );
      } else {
        newWindow.document.write(
          `<p style='text-align: center;'>${String(i + 1)}. ${
      ...
      if (gl_results[i][1].length === 2) {
        ...
        newWindow.document.write(
          katex.renderToString(
            "<p style='text-align: center; color: red;'>\\frac{" +
              gl_results[i][1][0] +
              "}{" +
              gl_results[i][1][1] +
              "}</p>"
        ...
        newWindow.document.write(
          `<p style='text-align: center; color: red;'>Invalid Array</p>`
        );
      }
    } else {
      if (containsKaTeXExpression(String(gl_results[i][1]))) {
        newWindow.document.write(
          `<p style='text-align: center; color: red;'>${katex.renderToString(
            gl_results[i][1]
          )}</p>`
        );
      } else {
        newWindow.document.write(
          `<p style='text-align: center; color: red;'>${gl_results[i][1]}</p>`
        );
      }
    }
  }
  ...
  for (let i = 0; i < gl_results.length; i++) {
    ...
    if (Array.isArray(gl_results[i][1])) {
      ...
      if (containsKaTeXExpression(String(gl_results[i][1]))) {
        ...
        newWindow.document.write(
          `${String(i + 1)}. <p style='text-align: center; color: red;'>${
            gl_results[i][1]
          }</p>`
        );
      }
...
function X_Generate(setting) {
  ...
  X_Operate.newSetting("General Settings", General_settings).then(
    (general_settings) => {
      X_Operate.newPage();
  ...
  setTimeout(() => {
    if (results[0] == true) {
      ...
      if (results[2] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Basic_Operations.Addition(
              Number(results[4]),
              Number(results[5])
            )
          );
      ...
      if (results[3] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Basic_Operations.Addition_w(
              Number(results[4]),
              Number(results[5])
            )
          );
    ...
    if (results[6] == true) {
      ...
      if (results[8] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Basic_Operations.Subtraction(
              Number(results[10]),
              Number(results[11])
            )
          );
      ...
      if (results[9] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Basic_Operations.Subtraction_w(
              Number(results[10]),
              Number(results[11])
            )
          );
    ...
    if (results[12] == true) {
      ...
      if (results[14] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Basic_Operations.Multiplication(
              Number(results[16]),
              Number(results[17])
            )
          );
      ...
      if (results[15] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Basic_Operations.Multiplication_w(
              Number(results[16]),
              Number(results[17])
            )
          );
    ...
    if (results[18] == true) {
      ...
      if (results[20] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Basic_Operations.Division(
              Number(results[22]),
              Number(results[23])
            )
          );
      ...
      if (results[21] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Basic_Operations.Division_w(
              Number(results[22]),
              Number(results[23])
            )
          );
    ...
    if (results[24] == true) {
      ...
      if (results[26] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Comparing_integers(
              Number(results[28]),
              Number(results[29])
            )
          );
      ...
      if (results[27] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Comparing_integers_w(
              Number(results[28]),
              Number(results[29])
            )
          );
    ...
    if (results[30] == true) {
      ...
      if (results[32] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Addition(
              Number(results[34]),
              Number(results[35]),
              Number(results[36])
            )
      ...
      if (results[33] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Addition_w(
              Number(results[34]),
              Number(results[35]),
              Number(results[36])
            )
    ...
    if (results[37] == true) {
      ...
      if (results[39] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Subtraction(
              Number(results[41]),
              Number(results[42]),
              Number(results[43])
            )
      ...
      if (results[40] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Subtraction_w(
              Number(results[41]),
              Number(results[42]),
              Number(results[43])
            )
    ...
    if (results[44] == true) {
      ...
      if (results[46] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Multiplication(
              Number(results[48]),
              Number(results[49]),
              Number(results[50])
            )
      ...
      if (results[47] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log(
            "Generating - Multiplication Integers Word: ",
            loop_length,
            i
          );
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Multiplication_w(
              Number(results[48]),
              Number(results[49]),
              Number(results[50])
            )
    ...
    if (results[51] == true) {
      ...
      if (results[53] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Division(
              Number(results[55]),
              Number(results[56]),
              Number(results[57])
            )
      ...
      if (results[54] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Integers.Division_w(
              Number(results[55]),
              Number(results[56]),
              Number(results[57])
            )
    ...
    if (results[58] == true) {
      ...
      if (results[60] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Addition(
              Number(results[62]),
              Number(results[63]),
              Number(results[64]),
              Number(results[65])
      ...
      if (results[61] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Addition_w(
              Number(results[62]),
              Number(results[63]),
              Number(results[64]),
              Number(results[65])
    ...
    if (results[66] == true) {
      ...
      if (results[68] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Subtraction(
              Number(results[70]),
              Number(results[71]),
              Number(results[72]),
              Number(results[73])
      ...
      if (results[69] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Subtraction_w(
              Number(results[70]),
              Number(results[71]),
              Number(results[72]),
              Number(results[73])
    ...
    if (results[74] == true) {
      ...
      if (results[76] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Multiplication(
              Number(results[78]),
              Number(results[79]),
              Number(results[80]),
              Number(results[81])
      ...
      if (results[77] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log(
            "Generating - Multiplication Decimals Word: ",
            loop_length,
            i
          );
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Multiplication_w(
              Number(results[78]),
              Number(results[79]),
              Number(results[80]),
              Number(results[81])
    ...
    if (results[82] == true) {
      ...
      if (results[84] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log("Generating - Division Decimals: ", loop_length, i);
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Division(
              Number(results[86]),
              Number(results[87]),
              Number(results[88]),
              Number(results[89])
      ...
      if (results[85] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log("Generating - Division Decimals Word: ", loop_length, i);
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Division_w(
              Number(results[86]),
              Number(results[87]),
              Number(results[88]),
              Number(results[89])
    ...
    if (results[90] == true) {
      ...
      if (results[92] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Comparing_decimals(
              Number(results[94]),
              Number(results[95]),
              Number(results[96])
            )
      ...
      if (results[93] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Decimals.Comparing_decimals_w(
              Number(results[94]),
              Number(results[95]),
              Number(results[96])
            )
    ...
    if (results[97] == true) {
      ...
      if (results[99] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Fractions.Addition(
              Number(results[101]),
              Number(results[102]),
              Number(results[103]),
              Number(results[104])
      ...
      if (results[100] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Fractions.Addition_w(
              Number(results[101]),
              Number(results[102]),
              Number(results[103]),
              Number(results[104])
    ...
    if (results[105] == true) {
      ...
      if (results[107] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Fractions.Subtraction(
              Number(results[109]),
              Number(results[110]),
              Number(results[111]),
              Number(results[112])
      ...
      if (results[108] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Fractions.Subtraction_w(
              Number(results[109]),
              Number(results[110]),
              Number(results[111]),
              Number(results[112])
    ...
    if (results[113] == true) {
      ...
      if (results[115] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Fractions.Multiplication(
              Number(results[117]),
              Number(results[118]),
              Number(results[119]),
              Number(results[120])
      ...
      if (results[116] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log(
            "Generating - Multiplication Fractions Word: ",
            loop_length,
            i
          );
          re_q.push(
            $X.math.Elementary_Mathematics.Fractions.Multiplication_w(
              Number(results[117]),
              Number(results[118]),
              Number(results[119]),
              Number(results[120])
    ...
    if (results[121] == true) {
      ...
      if (results[123] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Fractions.Division(
              Number(results[125]),
              Number(results[126]),
              Number(results[127]),
              Number(results[128])
      ...
      if (results[124] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Fractions.Division_w(
              Number(results[125]),
              Number(results[126]),
              Number(results[127]),
              Number(results[128])
    ...
    if (results[129] == true) {
      ...
      if (results[131] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log(
            "Generating - Division decimal to percentage: ",
            loop_length,
            i
          );
          re_q.push(
            $X.math.Elementary_Mathematics.Percentages.Converting_percentages(
              true,
              false,
              Number(results[133])
            )
      ...
      if (results[132] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log(
            "Generating - Convert percentage to decimal: ",
            loop_length,
            i
          );
          re_q.push(
    ...
    if (results[134] == true) {
      ...
      if (results[136] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Percentages.Calculating_percentages(
              Number(results[138]),
              Number(results[139])
            )
          );
      ...
      if (results[137] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log(
            "Generating - Calculating Percentages Word: ",
            loop_length,
            i
          );
          re_q.push(
            $X.math.Elementary_Mathematics.Percentages.Calculating_percentages_w(
              Number(results[138]),
              Number(results[139])
            )
          );
    ...
    if (results[140] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Elementary_Mathematics.Geometry.Recognizing_shapes(
            Number(results[142]),
            Number(results[143]),
            Number(results[144]),
            Number(results[145]),
    ...
    if (results[154] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Elementary_Mathematics.Geometry.perimeter_and_area(
            Number(results[156]),
            Number(results[157]),
            Number(results[158]),
            Number(results[159]),
    ...
    if (results[168] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Elementary_Mathematics.Geometry.volume(
            Number(results[170]),
            Number(results[171]),
            Number(results[172]),
            Number(results[173]),
    ...
    if (results[176] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Elementary_Mathematics.Time.Reading_clocks(results[178])
        );
      }
    }
    if (results[179] == true) {
    ...
    if (results[181] == true) {
      ...
      if (results[183] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Time.Calculations_clocks(
              results[185]
            )
          );
        }
      ...
      if (results[184] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Time.Calculations_clocks_w(
              results[185]
            )
          );
        }
    ...
    if (results[186] == true) {
      ...
      if (results[188] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Time.Calculations_calendars()
          );
        }
      }
      if (results[189] == true) {
        for (let i = 0; i < loop_length; i++) {
          ...
          re_q.push(
            $X.math.Elementary_Mathematics.Time.Calculations_calendars_w()
          );
        }
      }
    }
    if (results[190] == true) {
      ...
      if (results[192] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log(
            "Generating - Single variable linear equations: ",
            loop_length,
            i
          );
          re_q.push(
            $X.math.Middle_School_Mathematics.Algebra.Single_variable_linear_equations(
              Number(results[194]),
              Number(results[195]),
              results[196],
              results[197]
      ...
      if (results[193] == true) {
        for (let i = 0; i < loop_length; i++) {
          gen_log(
            "Generating - Single variable linear equations Word: ",
            loop_length,
            i
          );
          re_q.push(
            $X.math.Middle_School_Mathematics.Algebra.Single_variable_linear_equations_w(
              Number(results[194]),
              Number(results[195]),
              results[196],
              results[197]
    ...
    if (results[198] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Algebra.Quadratic_equations(
            Number(results[200]),
            Number(results[201])
          )
        );
    ...
    if (results[202] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Systems of two variable linear equation: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.Middle_School_Mathematics.Algebra.Systems_of_two_variable_linear_equation(
            Number(results[204]),
            Number(results[205]),
            Number(results[206]),
            results[207],
    ...
    if (results[209] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Algebra.Linear_inequality_of_one_variable(
            Number(results[211]),
            Number(results[212])
          )
        );
    ...
    if (results[213] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Algebra.Quadratic_inequality_of_one_variable(
            Number(results[215]),
            Number(results[216])
          )
        );
    ...
    if (results[217] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Algebra.Absolute_value_inequality(
            Number(results[219]),
            Number(results[220])
          )
        );
    ...
    if (results[221] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Algebra.Fractional_inequality(
            Number(results[223]),
            Number(results[224])
          )
        );
    ...
    if (results[225] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Algebra.Polynomials_and_factoring_Simplification(
            Number(results[227]),
            Number(results[228]),
            Number(results[229]),
            Number(results[230])
    ...
    if (results[231] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.Corresponding_angles()
        );
      }
    }
    if (results[233] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.Alternate_angles()
        );
      }
    }
    if (results[235] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.Congruence(
            results[237],
            results[238],
            results[239],
            results[240],
    ...
    if (results[245] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.Similarity(
            results[247],
            results[248],
            results[249],
            results[250],
    ...
    if (results[257] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.CircleCircumference()
        );
      }
    }
    if (results[259] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.CircleInscribedSquare()
        );
      }
    }
    if (results[261] == true) {
    ...
    if (results[263] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Distance of Chord Intersection: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.CircleChordDistance()
        );
      }
    }
    if (results[265] == true) {
    ...
    if (results[267] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.TrianglePerimeter()
        );
      }
    }
    if (results[269] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.AngleSumProperty()
        );
      }
    }
    if (results[271] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Pythagorean Theorem in Triangles: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.PythagoreanTheorem()
        );
      }
    }
    if (results[273] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.SimilarTriangles()
        );
      }
    }
    if (results[275] == true) {
    ...
    if (results[277] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.CorrespondingExteriorAngles()
        );
      }
    }
    if (results[279] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.AlternateInteriorAngles()
        );
      }
    }
    if (results[281] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.AlternateExteriorAngles()
        );
      }
    }
    if (results[283] == true) {
    ...
    if (results[285] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Trapezoid Perimeter Calculation: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.TrapezoidPerimeter()
        );
      }
    }
    if (results[287] == true) {
    ...
    if (results[289] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Geometry.Trigonometry(
            results[291],
            results[292],
            results[293]
          )
    ...
    if (results[294] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Statistics_and_Probability.Data_Collection_And_Analysis(
            results[296],
            results[297],
            results[298],
            results[299]
    ...
    if (results[300] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Statistics_and_Probability.Basic_Probability_Concepts(
            results[302],
            results[303],
            results[304],
            results[305]
    ...
    if (results[306] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.Middle_School_Mathematics.Statistics_and_Probability.Probability_Calculations(
            results[308],
            results[309],
            results[310],
            results[311]
    ...
    if (results[312] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Properties and Graphs of Trigonometric Functions: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.High_School_Mathematics.Trigonometry.TrigonometricFunctionsProperties(
            results[314],
            results[315],
            results[316],
            results[317],
    ...
    if (results[321] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.High_School_Mathematics.Trigonometry.TrigonometricIdentities(
            results[323],
            results[324],
            results[325]
          )
    ...
    if (results[326] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Solving trigonometric equations: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.High_School_Mathematics.Trigonometry.SolvingTrigonometricEquations(
            results[328],
            results[329],
            results[330]
          )
    ...
    if (results[331] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.High_School_Mathematics.Sequences_and_Series.ArithmeticAndGeometricSequences(
            results[333],
            results[334]
          )
        );
    ...
    if (results[335] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.High_School_Mathematics.Sequences_and_Series.SummationOfSequences(
            results[337],
            results[338]
          )
        );
    ...
    if (results[339] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.High_School_Mathematics.Sequences_and_Series.PropertiesOfSeries(
            results[341],
            results[342]
          )
        );
    ...
    if (results[343] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Calculating Derivatives and their Applications: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.High_School_Mathematics.Calculus.CalculatingDerivativesAndApplications(
            results[345],
            results[346]
          )
        );
    ...
    if (results[347] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Indefinite and Definite Integrals: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.High_School_Mathematics.Calculus.IndefiniteAndDefiniteIntegrals(
            results[349],
            results[350]
          )
        );
    ...
    if (results[351] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.High_School_Mathematics.Calculus.DifferentialEquations(
            results[353],
            results[354]
          )
        );
    ...
    if (results[355] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.University_Mathematics.Linear_Algebra.MatricesAndDeterminants(
            results[357],
            results[358],
            results[359]
          )
    ...
    if (results[360] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Vector Spaces and Linear Transformations: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Linear_Algebra.VectorSpacesAndLinearTransformations(
            results[362],
            results[363],
            results[364]
          )
    ...
    if (results[365] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.University_Mathematics.Linear_Algebra.EigenvaluesAndEigenvectors(
            results[367],
            results[368],
            results[369]
          )
    ...
    if (results[370] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Higher-order Differential Equations: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Differential_Equations.HigherOrderDifferentialEquations(
            results[372],
            results[373],
            results[374],
            results[375]
    ...
    if (results[376] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Solution Methods for Ordinary Differential Equations: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Differential_Equations.SolutionMethodsODE(
            results[378],
            results[379],
            results[380],
            results[381]
    ...
    if (results[382] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Random Variables and Probability Distributions: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Probability_and_Statistics.RandomVariablesAndDistributions(
            results[384],
            results[385],
            results[386]
          )
    ...
    if (results[387] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Statistical Inference and Hypothesis Testing: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Probability_and_Statistics.StatisticalInferenceAndHypothesisTesting(
            results[389],
            results[390],
            results[391]
          )
    ...
    if (results[392] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Complex Numbers and Complex Functions: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Complex_Analysis.ComplexNumbersAndFunctions(
            results[394],
            results[395],
            results[396]
          )
    ...
    if (results[397] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Analytic Functions and Conformal Mappings: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Complex_Analysis.AnalyticFunctionsAndMappings(
            results[399],
            results[400]
          )
        );
    ...
    if (results[401] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Modeling and Solving Linear Programming Problems: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Linear_Programming.LinearProgramming(
            results[403],
            results[404]
          )
        );
    ...
    if (results[405] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.University_Mathematics.Discrete_Mathematics.GraphTheory(
            results[407],
            results[408]
          )
        );
    ...
    if (results[409] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.math.University_Mathematics.Discrete_Mathematics.Combinatorics(
            results[411],
            results[412]
          )
        );
    ...
    if (results[413] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Applications of Discrete Mathematics in Computer Science: ",
          loop_length,
          i
        );
        re_q.push(
          $X.math.University_Mathematics.Discrete_Mathematics.Applications_Discrete_Math_CS(
            results[415],
            results[416]
          )
        );
    ...
    if (results[417] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.Elementary_Physics.Basic_Physics_Concepts.Matter_Properties(
            results[419],
            results[420],
            results[421]
          )
    ...
    if (results[422] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Size, Shape, and Color of Objects: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.Elementary_Physics.Basic_Physics_Concepts.Size_Shape_Color_Objects(
            results[424],
            results[425],
            results[426]
          )
    ...
    if (results[427] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Position and Direction of Objects: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.Elementary_Physics.Basic_Physics_Concepts.Position_Direction_Objects(
            results[429],
            results[430]
          )
        );
    ...
    if (results[431] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.Elementary_Physics.Force_and_Motion.Concept_Force(
            results[433],
            results[434]
          )
        );
    ...
    if (results[435] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.Elementary_Physics.Force_and_Motion.Motion_Rest_Objects(
            results[437],
            results[438]
          )
        );
    ...
    if (results[439] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.Elementary_Physics.Force_and_Motion.Simple_Machines(
            results[441],
            results[442]
          )
        );
    ...
    if (results[443] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Temperature and Temperature Measurement: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.Middle_School_Physics.Thermodynamics.Temperature_and_Temperature_Measurement(
            results[445],
            results[446]
          )
        );
    ...
    if (results[447] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.Middle_School_Physics.Thermodynamics.Heat_Conduction_and_Transfer(
            results[449],
            results[450]
          )
        );
    ...
    if (results[451] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Thermal Expansion of Materials: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.Middle_School_Physics.Thermodynamics.Thermal_Expansion_of_Materials(
            results[453],
            results[454]
          )
        );
    ...
    if (results[455] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Electric Charge and Static Electricity: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.Middle_School_Physics.Electromagnetism.Electric_Charge_and_Static_Electricity(
            results[457],
            results[458]
          )
        );
    ...
    if (results[459] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.Middle_School_Physics.Electromagnetism.Electric_Current_and_Circuits(
            results[461],
            results[462]
          )
        );
    ...
    if (results[463] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Magnetic Fields and Electromagnetic Induction: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.Middle_School_Physics.Electromagnetism.Magnetic_Fields_and_Electromagnetic_Induction(
            results[465],
            results[466]
          )
        );
    ...
    if (results[467] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.Middle_School_Physics.Acoustics.Propagation_of_Sound(
            results[469],
            results[470]
          )
        );
    ...
    if (results[471] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Characteristics and Frequency of Sound: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.Middle_School_Physics.Acoustics.Characteristics_and_Frequency_of_Sound(
            results[473],
            results[474]
          )
        );
    ...
    if (results[475] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Sound Reflection and Absorption: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.Middle_School_Physics.Acoustics.Sound_Reflection_and_Absorption(
            results[477],
            results[478]
          )
        );
    ...
    if (results[479] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.High_School_Physics.Mechanics.Kinematics(
            results[481],
            results[482]
          )
        );
    ...
    if (results[483] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Newton Laws and Equilibrium of Forces: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.High_School_Physics.Mechanics.NewtonLawsAndEquilibrium(
            results[485],
            results[486],
            results[487],
            results[488]
    ...
    if (results[489] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.High_School_Physics.Mechanics.MomentumAndEnergy(
            results[491],
            results[492],
            results[493],
            results[494]
    ...
    if (results[495] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Propagation and Reflection of Light: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.High_School_Physics.Optics.PropagationAndReflectionOfLight(
            results[497],
            results[498],
            results[499],
            results[500]
    ...
    if (results[501] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.High_School_Physics.Optics.MirrorsAndLenses(
            results[503],
            results[504],
            results[505],
            results[506]
    ...
    if (results[507] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Wave Particle Duality of Light: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.High_School_Physics.Optics.WaveParticleDualityOfLight(
            results[509],
            results[510],
            results[511]
          )
    ...
    if (results[512] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Atomic Structure and the Periodic-table: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.High_School_Physics.Atomic_and_Nuclear_Physics.AtomicStructureAndPeriodicTable(
            results[514],
            results[515],
            results[516]
          )
    ...
    if (results[517] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Nuclear Reactions and Radioactive Decay: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.High_School_Physics.Atomic_and_Nuclear_Physics.NuclearReactionsAndRadioactiveDecay(
            results[519],
            results[520]
          )
        );
    ...
    if (results[521] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.High_School_Physics.Atomic_and_Nuclear_Physics.StructureOfAtomicNuclei(
            results[523],
            results[524]
          )
        );
    ...
    if (results[525] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.University_Physics.Thermodynamics.IdealGasLaw(
            results[527],
            results[528],
            results[529],
            results[530]
    ...
    if (results[531] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.University_Physics.Thermodynamics.ThermodynamicCycles(
            results[533],
            results[534],
            results[535]
          )
    ...
    if (results[536] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Entropy and the Second Law of Thermodynamics: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.University_Physics.Thermodynamics.EntropyAndSecondLaw(
            results[538],
            results[539]
          )
        );
    ...
    if (results[540] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.University_Physics.Electromagnetism.MaxwellEquations(
            results[542],
            results[543],
            results[544]
          )
    ...
    if (results[545] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Electromagnetic Waves and the Propagation of Light: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.University_Physics.Electromagnetism.ElectromagneticWavesAndPropagation(
            results[547],
            results[548],
            results[549]
          )
    ...
    if (results[550] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Interaction of Electromagnetic Fields: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.University_Physics.Electromagnetism.InteractionOfElectromagneticFields(
            results[552],
            results[553]
          )
        );
    ...
    if (results[554] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.University_Physics.Quantum_Mechanics.WaveParticleDuality(
            results[556],
            results[557],
            results[558]
          )
    ...
    if (results[559] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Wave Functions and the Schrodinger Equation: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.University_Physics.Quantum_Mechanics.WaveFunctionsAndSchrodingerEquation(
            results[561],
            results[562]
          )
        );
    ...
    if (results[563] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Operators and Measurements in Quantum Mechanics: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.University_Physics.Quantum_Mechanics.OperatorsAndMeasurementsInQuantumMechanics(
            results[565],
            results[566]
          )
        );
    ...
    if (results[567] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Special Relativity and the Lorentz Transformation: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.University_Physics.Relativity.SpecialRelativityAndLorentzTransformation(
            results[569],
            results[570]
          )
        );
    ...
    if (results[571] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.University_Physics.Relativity.MassEnergyEquivalence(
            results[573],
            results[574]
          )
        );
    ...
    if (results[575] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Gravity and General Relativity: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.University_Physics.Relativity.GravityAndGeneralRelativity(
            results[577],
            results[578]
          )
        );
    ...
    if (results[579] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Crystal Structures and Lattice Vibrations: ",
          loop_length,
          i
        );
        re_q.push(
          $X.physics.University_Physics.Solid_State_Physics.CrystalStructuresAndLatticeVibrations(
            results[581],
            results[582]
          )
        );
    ...
    if (results[583] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.University_Physics.Solid_State_Physics.ElectronicBandTheory(
            results[585],
            results[586],
            results[587]
          )
    ...
    if (results[588] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.physics.University_Physics.Solid_State_Physics.SemiconductorsAndConductors(
            results[590],
            results[591]
          )
        );
    ...
    if (results[592] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.Elementary_Chemistry.Matter_and_Properties.ClassificationOfMatter(
            results[594],
            results[595]
          )
        );
    ...
    if (results[596] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.Elementary_Chemistry.Matter_and_Properties.PropertiesOfMatter(
            results[598],
            results[599],
            results[600]
          )
    ...
    if (results[601] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Differences between Mixtures and Pure-Substances: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.Elementary_Chemistry.Mixtures_and_Pure_Substances.DifferencesBetweenMixturesAndPureSubstances(
            results[603],
            results[604]
          )
        );
    ...
    if (results[605] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.Elementary_Chemistry.Mixtures_and_Pure_Substances.MethodsToSeparateMixtures(
            results[607],
            results[608],
            results[609]
          )
    ...
    if (results[610] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Definitions of Elements and Compounds: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.Middle_School_Chemistry.Elements_and_Compounds.DefinitionsOfElementsAndCompounds(
            results[612],
            results[613],
            results[614]
          )
    ...
    if (results[615] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Chemical Symbols and the Periodic-table: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.Middle_School_Chemistry.Elements_and_Compounds.ChemicalSymbolsAndThePeriodicTable(
            results[617],
            results[618]
          )
        );
    ...
    if (results[619] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Basic Concepts of Chemical Reactions: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.Middle_School_Chemistry.Chemical_Reactions.BasicConceptsOfChemicalReactions(
            results[621],
            results[622],
            results[623]
          )
    ...
    if (results[624] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.Middle_School_Chemistry.Chemical_Reactions.ChemicalReactionEquations(
            results[626],
            results[627],
            results[628]
          )
    ...
    if (results[629] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.Middle_School_Chemistry.Acids_and_Bases.PropertiesOfAcidsAndBases(
            results[631],
            results[632],
            results[633]
          )
    ...
    if (results[634] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.Middle_School_Chemistry.Acids_and_Bases.NeutralizationReactions(
            results[636],
            results[637],
            results[638]
          )
    ...
    if (results[639] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Atomic and Molecular Structure: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.High_School_Chemistry.Chemical_Bonds_and_Molecular_Structure.AtomicAndMolecularStructure(
            results[641],
            results[642]
          )
        );
    ...
    if (results[643] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.High_School_Chemistry.Chemical_Bonds_and_Molecular_Structure.CovalentAndIonicBonds(
            results[645],
            results[646]
          )
        );
    ...
    if (results[647] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Reaction Rates and Activation Energy: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.High_School_Chemistry.Chemical_Reaction_Kinetics.ReactionRatesAndActivationEnergy(
            results[649],
            results[650]
          )
        );
    ...
    if (results[651] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Chemical Equilibrium and Le-Chatelier-Principle: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.High_School_Chemistry.Chemical_Reaction_Kinetics.ChemicalEquilibriumAndLeChateliersPrinciple(
            results[653],
            results[654]
          )
        );
    ...
    if (results[655] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Equilibrium Constants for Chemical Reactions: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.High_School_Chemistry.Chemical_Reaction_Kinetics.EquilibriumConstantsForChemicalReactions(
            results[657],
            results[658]
          )
        );
    ...
    if (results[659] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.High_School_Chemistry.Chemical_Thermodynamics.HeatAndEnthalpy(
            results[661],
            results[662],
            results[663],
            results[664]
    ...
    if (results[665] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.High_School_Chemistry.Chemical_Thermodynamics.ThermochemicalEquations(
            results[667],
            results[668],
            results[669]
          )
    ...
    if (results[670] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Reaction Enthalpy and Entropy Changes: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.High_School_Chemistry.Chemical_Thermodynamics.ReactionEnthalpyAndEntropyChanges(
            results[672],
            results[673],
            results[674]
          )
    ...
    if (results[675] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Structure and Nomenclature of Organic Molecules: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.University_Chemistry.Organic_Chemistry.StructureAndNomenclatureOfOrganicMolecules(
            results[677],
            results[678]
          )
        );
    ...
    if (results[679] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Reaction Mechanisms in Organic Chemistry: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.University_Chemistry.Organic_Chemistry.ReactionMechanismsInOrganicChemistry(
            results[681],
            results[682]
          )
        );
    ...
    if (results[683] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.University_Chemistry.Inorganic_Chemistry.MetalAndNonMetalElements(
            results[685],
            results[686]
          )
        );
    ...
    if (results[687] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Coordination Chemistry and Transition Metal Compounds: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.University_Chemistry.Inorganic_Chemistry.CoordinationChemistryAndTransitionMetalCompounds(
            results[689],
            results[690]
          )
        );
    ...
    if (results[691] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.University_Chemistry.Analytical_Chemistry.MethodsOfChemicalAnalysis(
            results[693],
            results[694]
          )
        );
    ...
    if (results[695] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Mass Spectrometry and Infrared Spectroscopy: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.University_Chemistry.Analytical_Chemistry.MassSpectrometryAndInfraredSpectroscopy(
            results[697],
            results[698]
          )
        );
    ...
    if (results[699] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Solubility and Solution Concentration: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.University_Chemistry.Properties_of_Matter.SolubilityAndSolutionConcentration(
            results[701],
            results[702]
          )
        );
    ...
    if (results[703] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.University_Chemistry.Properties_of_Matter.RedoxReactions(
            results[705],
            results[706]
          )
        );
    ...
    if (results[707] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        ...
        re_q.push(
          $X.chemistry.University_Chemistry.Nuclear_Chemistry.RadioactiveDecayProcesses(
            results[709],
            results[710],
            results[711]
          )
    ...
    if (results[712] == true) {
      ...
      for (let i = 0; i < loop_length; i++) {
        gen_log(
          "Generating - Nuclear Reactions and Nuclear Energy: ",
          loop_length,
          i
        );
        re_q.push(
          $X.chemistry.University_Chemistry.Nuclear_Chemistry.NuclearReactionsAndNuclearEnergy(
            results[714],
            results[715],
            results[716]
          )
